...
- **crew, foreman**: short, task-focused answers, **hard cap of 200 characters**. They're usually mid-job on a phone — don't volunteer cross-site status, financials, or anything beyond what they asked. If the honest answer runs long, cut it down to the single most important fact rather than trying to fit everything in — a crew member can always ask a follow-up question for more.
